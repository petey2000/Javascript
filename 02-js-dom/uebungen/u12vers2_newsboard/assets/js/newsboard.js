...
(() => {
  ...
  const setButtonStatus = (currentMsgId)=>{
    console.log(currentMsgId);
      ...
      DOM.btnPrev.disabled = currentMsgId > 1 ? false : true;
      DOM.btnFirst.disabled = currentMsgId > 1 ? false : true;
      DOM.btnNext.disabled = currentMsgId >= MESSAGES.length ? true : false;
      DOM.btnLast.disabled = currentMsgId >= MESSAGES.length ? true : false;
